      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-3xl mt-24 md:mt-0">
          ...
          <button
            ...
            className="px-2 py-2 md:px-6 md:py-3 text-sm! md:text-sm border border-white text-white font-medium font-graphik uppercase tracking-wider transition-all duration-300 hover:bg-white hover:text-black mt-4 md:mt-6"
          >
