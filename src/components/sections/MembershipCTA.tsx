  ...
  return (
    ...
    <section id="membership-cta" className="relative min-h-[70vh] md:min-h-screen  flex flex-col bg-white overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-3xl mt-24 md:mt-0">
          <p className="text-[10px] md:text-sm uppercase tracking-[0.2em] md:tracking-[0.3em] text-white/90 mb-4 md:mb-6 font-graphik">
            EXPERIENCE A NEW STANDARD IN WELLNESS.
          </p>

          <h2 className="text-lg md:text-3xl lg:text-4xl text-white font-light font-graphik leading-relaxed mb-1 md:mb-8">
          ...
          <button
            ...
            className="px-4 py-2 md:px-6 md:py-3 text-xs md:text-sm border border-white text-white font-medium font-graphik uppercase tracking-wider transition-all duration-300 hover:bg-white hover:text-black mt-4 md:mt-6"
          >
