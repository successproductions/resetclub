...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#f5efe8] text-white">
      ...
      <div className="hidden md:block max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-2">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <div className="flex space-x-3">
                <Link
                  href="https://www.facebook.com/profile.php?id=61572122909339"
                  target="_blank"
                  ...
                  aria-label="Facebook"
                >
                  <svg className="w-6 h-6 text-white hover:text-gray-950" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </Link>
                <Link
                  href="https://www.instagram.com/resetclub_rabat/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-950 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-[#f5efe8] hover:transform hover:scale-110"
                ...
                <Link
                  href="https://www.tiktok.com/@holisticare_rabat?is_from_webapp=1&sender_device=pc"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-950 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-[#f5efe8] hover:transform hover:scale-110"
                  aria-label="TikTok"
          ...
          {Object.entries(footerLinks).map(([key, section]) => (
            <div key={key}>
              <p className="text-xl mt-12 md:text-2xl font-normal mb-10 text-gray-950 font-graphik">
                {t(section.titleKey)}
              </p>
      ...
      <div className="md:hidden flex flex-col items-center justify-center px-6 py-8 text-center bg-[#e4ded5] ">
        ...
        <div className="flex space-x-4 mb-8">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
            aria-label="Facebook"
          >
        ...
        {/* Tagline */}
        {/* <p className="text-gray-950 mb-8 max-w-sm text-sm font-poppins">
          {t('mobileTagline')}
        </p> */}
        ...
        {/* <Link
          href="/contact"
          className="bg-transparent text-gray-950 text-lg font-graphik px-4 font-medium py-4   font-fraphik border border-[#524029] hover:border-[#] hover:bg-gray-950 hover:text-white transition-all duration-300 inline-block cursor-pointer hover:scale-105 shadow-lg hover:shadow-xl"
        >
          {t('mobileCtaButton')}
        </Link> */}
      </div>
