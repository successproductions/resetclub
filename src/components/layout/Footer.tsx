    ...
    <footer className="bg-[#f5efe8] text-white">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <div className="flex space-x-3">
                <a
                  href="#"
                  className="w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-[#c26d4c] hover:transform hover:scale-110"
                  aria-label="Facebook"
                >
      ...
      <div className="md:hidden flex flex-col items-center justify-center px-6 py-8 text-center bg-[#e4ded5] ">
        ...
        <div className="flex space-x-4 mb-8">
          ...
          <a
            href="#"
            className="w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center transition-all duration-300"
            aria-label="Facebook"
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
