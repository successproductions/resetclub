    ...
    <footer className="bg-[#f5efe8] text-white">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4">
              ...
              <div className="flex space-x-3">
                <button
                  type="button"
                  className="w-12 h-12 bg-gray-950 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-[#f5efe8] hover:transform hover:scale-110 cursor-not-allowed opacity-50"
      ...
      <div className="md:hidden flex flex-col items-center justify-center px-6 py-8 text-center bg-[#e4ded5] ">
        ...
        <div className="flex space-x-4 mb-8">
          ...
          <button
            type="button"
            className="w-12 h-12 bg-gray-900 rounded-full flex items-center justify-center transition-all duration-300 cursor-not-allowed opacity-50"
            aria-label="Facebook (Coming Soon)"
            disabled
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
