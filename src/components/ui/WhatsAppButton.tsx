              ...
              {showMessages && (
                <div className="mt-6 space-y-2 animate-fade-in">
                  <button
                    ...
                    className="w-full text-white py-3 px-6 flex items-center justify-center space-x-2 hover:opacity-90 transition-colors cursor-pointer"
                    style={{ backgroundColor: '#040613' }}
                  >
