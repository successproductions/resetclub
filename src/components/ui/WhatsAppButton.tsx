...
export default function WhatsAppButton({
 ...
 <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 rounded-full border-1 "></div>
              ...
              {showMessages && (
                <div className="mt-6 space-y-2 animate-fade-in">
                  <button
                    ...
                    className="w-full text-white py-3 px-6 rounded-full flex items-center justify-center space-x-2 hover:opacity-90 transition-colors cursor-pointer"
                    style={{ backgroundColor: '#c26d4c' }}
                  >
                  ...
                  <button
                    ...
                    className="w-full bg-[#25D366] hover:bg-[#20BA5A] text-white py-3 px-6 rounded-full flex items-center justify-center space-x-2 transition-colors"
                  >
        ...
        {/* ChatBot Modal */}
        {showChatBot && (
          <div className="absolute bottom-16 right-0 w-96 h-[600px] bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in">
            <ChatBot
              onClose={() => {
