...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function isWithinBounds(clientX: number, clientY: number): boolean {
      if (!boundingElement) return true;
    ...
    function generateColor(): ColorRGB {
      // Your custom colors with 40% opacity: #0bcee1, #088c9c, #e2fffa, #073b4a
      const colors = [
        { r: 0.043 * 0.4, g: 0.808 * 0.4, b: 0.882 * 0.4 }, // #0bcee1
        { r: 0.031 * 0.4, g: 0.549 * 0.4, b: 0.612 * 0.4 }, // #088c9c
        { r: 0.886 * 0.4, g: 1.0 * 0.4, b: 0.98 * 0.4 },    // #e2fffa
        { r: 0.027 * 0.4, g: 0.231 * 0.4, b: 0.290 * 0.4 }  // #073b4a
      ];
